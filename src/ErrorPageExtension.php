...
class ErrorPageExtension extends DataExtension
{
     ...
     */
    public function createErrorCodeField()
    {
        $owner = $this->owner;
     ...
     */
    public function responseFor($statusCode)
    {
        $owner = $this->owner;

        // first attempt to dynamically generate the error page
        /** @var ErrorPage $errorPage */
        $errorPage = DataObject::get($owner->ClassName)
            ->filter(['ErrorCode' => $statusCode])
            ->first();
     ...
     * @return string|null
     */
    public function getContentForErrorcode($statusCode)
    {
        $owner = $this->owner;
     ...
     * @return array
     */
    public function getDefaultRecordsData()
    {
        $owner = $this->owner;
        $data = [
            [
    ...
    protected function addErrorCodeFieldLabel($labels): array
    {
     ...
     */
    protected function ensureStaticPage()
    {
        $owner = $this->owner;
     ...
     * @return string
     */
    protected function getErrorFilename($statusCode = null)
    {
        $owner = $this->owner;
